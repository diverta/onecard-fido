...
[MDBT50Q Dongle](../../FIDO2Device/MDBT50Q_Dongle/README.md)に、[USBブートローダー（暗号化対応版）](../../nRF5_SDK_v15.3.0/firmwares/secure_bootloader)が導入されていることが前提となります。<br>
...
|2|DFU対象デバイスからMTUを取得|イメージ送信１回あたりのフレームサイズ(MTU)を取得します。|
|3|datイメージを転送|復号化に必要な公開鍵や、プログラムイメージ配置に関する情報等を<br>転送します。|
|4|binイメージを転送|Flash ROMに配置されるプログラムイメージを転送します。|
