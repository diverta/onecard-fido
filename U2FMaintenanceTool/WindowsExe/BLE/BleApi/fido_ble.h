...
#define FIDO_BLE_VERSIONBITFIELD_VERSION_1_1_OFFSET    0
#define FIDO_BLE_VERSIONBITFIELD_VERSION_1_1_BIT       0x80

#define FIDO_BLE_SERVICEDATA_PAIRINGMODE  0x80
#define FIDO_BLE_SERVICEDATA_PASSKEYENTRY 0x40
