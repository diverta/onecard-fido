...
[FIDO認証器管理ツール](../../MaintenanceTool/macOSApp/README.md)を使用して、FIDO認証器にPINコード（暗証番号）を設定する手順を掲載します。
...
[管理ツール（macOS版）](../../MaintenanceTool/macOSApp/README.md)を、PC環境（macOS）に導入します。<br>
以下の手順書をご参照願います。
