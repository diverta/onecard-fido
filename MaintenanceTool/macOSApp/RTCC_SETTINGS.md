...
本ドキュメントでは「[MDBT50Q Dongle（rev2.2）](../../FIDO2Device/MDBT50Q_Dongle/README.md)」[注1]を、FIDO2認証器として使用します。
...
最新バージョンの[管理ツール（macOS版）](../../MaintenanceTool/macOSApp/MNTTOOL.md)[注1] を、PC環境（macOS）に導入します。<br>
以下の手順書をご参照願います。
