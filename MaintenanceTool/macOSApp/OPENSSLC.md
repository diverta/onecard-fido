...
ユーザーディレクトリー配下にできたインクルードファイルと、libcrypto.aを、開発時に使用するため、Xcodeプロジェクトに組み込みます。

### パスの追加指定

Xcodeプロジェクトの`Search Paths`設定に、インクルードファイル／ライブラリーファイルのパスを設定します。<br>
設定箇所は下記になります。

<b>【ベンダー向け管理ツール】</b>

<img src="assets09/0006.jpg" width="700">

<b>【エンドユーザー向け管理ツール】</b>

<img src="assets09/0005.jpg" width="700">

### ビルドの実行

パスを追加指定したら、ビルドを実行します。<br>
「Build Succeeded」と表示されれば、ビルドは成功になります。

<b>【ベンダー向け管理ツール】</b>

<img src="assets09/0007.jpg" width="700">

<b>【エンドユーザー向け管理ツール】</b>

<img src="assets09/0008.jpg" width="700">
