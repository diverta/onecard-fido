...
[FIDO認証器管理ツール](../../MaintenanceTool/macOSApp/README.md)を使用して、[MDBT50Q Dongle](../../FIDO2Device/MDBT50Q_Dongle/README.md)に対し、OpenPGP機能の各種設定を行う手順を掲載します。
...
OpenPGP機能の設定は「OpenPGP設定画面」上から行います。
...
認証器がUSBに装着されたまま、認証器のファームウェアが再起動します。
