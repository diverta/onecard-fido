...
|2|ペアリングを必要とする |スマートフォンをBLEデバイスとして使用したい場合[注1]はチェックをOnにします。<br>Offにすると無効化されます。[注2]||
|3|スキャン対象サービスUUID |「422E0000-E141-11E5-A837-0800200C9A66」といった形式で入力します。|自動認証機能を有効化しない場合は入力不要|
