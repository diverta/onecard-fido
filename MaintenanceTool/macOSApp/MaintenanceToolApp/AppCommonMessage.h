...
#define MSG_FORMAT_ERROR_PIV_IMPORT_PKEY_FAILED @"PIV秘密鍵インポート処理が失敗しました（slot=0x%02x, alg=0x%02x）。"
#define MSG_FORMAT_ERROR_PIV_IMPORT_CERT_FAILED @"PIV証明書インポート処理が失敗しました（slot=0x%02x, alg=0x%02x）。"
#define MSG_FORMAT_PIV_PKEY_PEM_IMPORTED        @"PIV秘密鍵を正常にインポートしました（slot=0x%02x, alg=0x%02x）。"
#define MSG_FORMAT_PIV_CERT_PEM_IMPORTED        @"PIV証明書を正常にインポートしました（slot=0x%02x, alg=0x%02x）。"
