...
namespace ToolAppCommon
{
    internal class HIDDevice
    {
        ...
        public static InterfaceDetails[] GetConnectedDevices()
        {
            ...
            while (b) {
                ...
                if (buffer != IntPtr.Zero) {
                    ...
                    if (HidD_GetSerialNumberString(tempHandle, buffer, 126)) {
        ...
        private readonly SafeFileHandle handle_read;
        private readonly SafeFileHandle handle_write;
        private HIDP_CAPS capabilities;

        public InterfaceDetails productInfo;
        public bool DeviceConnected { get; set; }

        private FileStream FS_read = null!;
