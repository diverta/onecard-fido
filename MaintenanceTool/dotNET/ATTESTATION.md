...
<img src="assets08/0028.jpg" width="400">

確認ダイアログが表示されますので「はい」をクリックします。

<img src="assets08/0029.jpg" width="400">

FIDO認証器側の処理が成功すると「鍵・証明書の削除が成功しました。」と表示されます。

<img src="assets08/0030.jpg" width="400">
