...
uint8_t *USBFIDO::configurationDesc() 
{
...
uint8_t *USBFIDO::stringImanufacturerDesc() 
{
...
uint8_t *USBFIDO::stringIproductDesc() 
{
...
uint8_t * USBFIDO::stringIserialDesc() 
{
