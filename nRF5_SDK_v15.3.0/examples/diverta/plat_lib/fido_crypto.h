...
#define RAW_PRIVATE_KEY_SIZE    NRF_CRYPTO_ECC_SECP256R1_RAW_PRIVATE_KEY_SIZE
#define RAW_PUBLIC_KEY_SIZE     NRF_CRYPTO_ECC_SECP256R1_RAW_PUBLIC_KEY_SIZE
#define SHARED_SECRET_SIZE      NRF_CRYPTO_ECDH_SECP256R1_SHARED_SECRET_SIZE
