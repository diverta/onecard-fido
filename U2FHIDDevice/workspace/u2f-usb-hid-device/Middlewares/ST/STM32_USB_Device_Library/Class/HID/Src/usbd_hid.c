...
__ALIGN_BEGIN static uint8_t HID_ReportDesc[HID_REPORT_DESC_SIZE]  __ALIGN_END =
{
	...
	0x95, 32,           //   REPORT_COUNT (input=32)
	0x81, 0x02,         //   INPUT (Data | Absolute | Variable)
	0x09, 0x21,         //   USAGE (Output Report Data)
	0x15, 0x00,         //   LOGICAL_MINIMUM (0)
	0x26, 0xff, 0x00,   //   LOGICAL_MAXIMUM (255)
	0x75, 0x08,         //   REPORT_SIZE (8)
	0x95, 64,           //   REPORT_COUNT (output=64)
                               ...
                               uint8_t cfgidx)
{
  ...
  USBD_LL_OpenEP(pdev, HID_EPIN2_ADDR, USBD_EP_TYPE_INTR, HID_EPIN_SIZE);
  
  /* Open EP OUT */
  USBD_LL_OpenEP(pdev, HID_EPOUT_ADDR,  USBD_EP_TYPE_INTR, HID_EPOUT_SIZE);
  USBD_LL_OpenEP(pdev, HID_EPOUT2_ADDR, USBD_EP_TYPE_INTR, HID_EPOUT_SIZE);
