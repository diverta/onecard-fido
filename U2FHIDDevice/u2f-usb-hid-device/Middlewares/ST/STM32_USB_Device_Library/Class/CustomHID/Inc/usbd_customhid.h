...
#define CUSTOM_HID_EPIN2_ADDR                0x82
#define CUSTOM_HID_EPIN_SIZE                 0x40 // 64 bytes

#define CUSTOM_HID_EPOUT_ADDR                0x01
#define CUSTOM_HID_EPOUT2_ADDR               0x02
#define CUSTOM_HID_EPOUT_SIZE                0x40 // 64 bytes

#define USB_CUSTOM_HID_CONFIG_DESC_SIZ       73
