...
//bmpOfst,   w,   h, xAdv, xOfst, yOfst
	{     0,   0,   0,  12,    0,    1 },   // 0x20 ' '
	{     0,   4,  34,  16,    6,  -33 },   // 0x21 '!'
	{    15,  11,  12,  16,    2,  -32 },   // 0x22 '"'		2
	{    31,  24,  33,  26,    1,  -31 },   // 0x23 '#'  	3
	{   129,  23,  41,  26,    1,  -34 },   // 0x24 '$'  	4
	{   246,  39,  34,  42,    1,  -32 },   // 0x25 '%'  	5
	{   411,  28,  34,  31,    2,  -32 },   // 0x26 '&'  	6
	{   529,   4,  12,   9,    2,  -32 },   // 0x27 '''		7
	{   534,  10,  44,  16,    3,  -33 },   // 0x28 '('		8
	
//	{   597,  10,  44,  16,    2,  -33 },   // 0x29 ')'
	{   588,  10,  44,  16,    2,  -33 },   // 0x29 ')'		9
