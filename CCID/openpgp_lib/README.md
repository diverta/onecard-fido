...
|1-4|`ccid_openpgp_attr.h`|属性データ関連処理|
|1-5|`ccid_openpgp_crypto.c/.h`|署名／復号化処理|
|1-6|`ccid_openpgp_data.c/.h`|鍵／データオブジェクト更新処理|
|1-7|`ccid_openpgp_key_rsa.c/.h`|RSA鍵関連処理|
|1-8|`ccid_openpgp_key.c/.h`|鍵関連処理|
|1-9|`ccid_openpgp_object.c/.h`|データオブジェクト関連処理|
|1-10|`ccid_openpgp_pin.c/.h`|PIN認証処理のエントリーモジュール|
|1-11|`ccid_openpgp.c/.h`|エントリーモジュール|
|1-12|`ccid_pin_auth.c/.h`|PINおよびリトライカウンター関連処理|
|1-13|`ccid_pin.h`|PINに関する定義体|
...
[注1]デフォルトのPIN番号を使用した認証機能のみが実装されています。<br>
...
|#|TAG|名称|説明|
|:---:|:---|:---|:---|
|1|`0x01`|`TAG_OPGP_PW1`|ユーザーPIN番号[注2][注4]|
|2|`0x02`|`TAG_OPGP_PW3`|管理者PIN番号[注2][注5]|
...
本プロジェクトでAIDとして設定する値は、下記の通り一部ダミー値になります。
