...
|4|`0x2C`|`0x00`|`0x81`|Reset PIN, auth with <br>resetting code|PIN番号をリセット<br>（リセットコードを使用し認証実行）|
|5|`0x2C`|`0x02`|`0x81`|Reset PIN|PIN番号をリセット|
|6|`0xDA`|`0x00`|`0xD3`|Change resetting code|リセットコードを変更|
...
|#|INS|P1|P2|名称|説明|
|:---:|:---|:---|:---|:---|:---|
|1|`0x2C`|`0x02`|`0x81`|Reset PIN|PIN番号をリセット|

<b>リクエストデータ</b>

|#|Offset|桁数|名称|説明|
|:---:|:---|:---|:---|:---|
|1|0|6|新しいPIN番号|画面入力値|
...
|#|INS|P1|P2|名称|説明|
|:---:|:---|:---|:---|:---|:---|
|1|`0x2C`|`0x00`|`0x81`|Reset PIN, auth with <br>resetting code|PIN番号をリセット<br>（リセットコードを使用し認証実行）|

<b>リクエストデータ</b>

|#|Offset|桁数|名称|説明|
|:---:|:---|:---|:---|:---|
|1|0|8|現在のリセットコード|画面入力値|
|2|8|6|新しいPIN番号|画面入力値|
